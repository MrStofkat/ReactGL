class DetectBrowser {
  ...
  static browser() {
    ...
    if (navigator.userAgent.indexOf("Chrome") != -1 && !isEdge) browserName = 'chrome';
    else if (navigator.userAgent.indexOf("Safari") != -1 && !isEdge) browserName = 'safari';
    else if (navigator.userAgent.indexOf("Firefox") != -1 ) browserName = 'firefox';  
    else if ((navigator.userAgent.indexOf("MSIE") != -1 ) || (!!document.documentMode == true )) browserName = 'ie';
